...
export default function Mascot({ size = 64 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" role="img" aria-label="生物小細胞吉祥物">
      ...
      {/* nucleus */}
      <circle cx="32" cy="34" r="9" fill="#ffd1e6" />
      {/* face */}
      <circle cx="28.5" cy="33" r="1.8" fill="#5b4660" />
      <circle cx="35.5" cy="33" r="1.8" fill="#5b4660" />
      <path d="M28 38c2.2 2.6 6 2.6 8 0" stroke="#e23080" strokeWidth="2" fill="none" strokeLinecap="round" />
      <circle cx="25.5" cy="36.5" r="2" fill="#ff9ec8" opacity="0.7" />
      <circle cx="38.5" cy="36.5" r="2" fill="#ff9ec8" opacity="0.7" />
    </svg>
  );
}
